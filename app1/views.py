...
def contactus(requests):
    data={"isusername":"hidden","isemail":"hidden"}
    return render(requests,"login/contactus.html",data)

def about(requests):
    data={"isusername":"hidden","isemail":"hidden"}
    return render(requests,"login/about.html",data)
...
def contact_us(request):
    if request.method == 'POST':
        ...
        # Handle form submission logic here, e.g., save to database or send email
